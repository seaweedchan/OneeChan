        ...
        DOMLoaded: function(reload)
        {
            ...
            if (reload !== true)
            {
                ...
                setTimeout(function()
                {
                    ...
                    $("#navtopright").append($(".exlinksOptionsLink"));
