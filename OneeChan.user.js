            ...
            [
                {
                    ...
                    titleColor: "b88cd1",
                    timeColor:  "dddddd",
                    customCSS:  '" + ($SS.conf["Add Shadow?"] ? ".thread>.replyContainer>.reply>div.postInfo { box-shadow: 0px 2px 3px #0A0A0A !important; }" : "") + "'
                },
                {
                    name:        "Muted",
                    author:      "seaweed",
                ...
                },
                {
                    ...
                    titleColor:  "cc1105",
                    timeColor:   "800000",
                    customCSS:   '\n\n\n\n\n\n#boardNavDesktop a, .pages a, .postNum a { color: #800000 !important; } a.summary { color: #0000ee !important; } #boardNavDesktop,.pagelist,#imgControls,html::after{background:rgba(254, 215, 176," + this.navOp + ")!important;}#delform,.reply,.hidden_thread,.stub{border-radius:0!important}\n.reply,.hidden_thread,.stub"+($SS.conf["Recolor Even Posts"] ? ",.replyContainer:nth-of-type(even)>div" : "")+"{border-left:1px solid "+this.mainColor.hex+"!important;border-top:1px solid "+this.mainColor.hex+"!important;}.boardTitle { text-shadow: 1px 1px 1px #772E28 !important; }.boardSubtitle, .boardBanner .boardSubtitle > a{text-shadow: none !important;}'
                },                                                              
                {
                    name:        "Yotsuba B",
                    "default":   true,
                    ...
                    titleColor:  "0f0c5d",
                    timeColor:   "000000",
                    customCSS:   '\n\n\n\n\n\na.quotelink:not(:hover){color:#cc2200!important;}#boardNavDesktop,.pagelist,#imgControls,html::after{background:rgba(210, 214, 239," + this.navOp + ")!important;}#delform,.reply,.hidden_thread,.stub{border-radius:0!important}.reply,.hidden_thread,.stub"+($SS.conf["Recolor Even Posts"] ? ",.replyContainer:nth-of-type(even)>div" : "")+"{border-left:1px solid "+this.mainColor.hex+"!important;border-top:1px solid "+this.mainColor.hex+"!important;}.boardTitle {color: #AF0A0F !important;text-shadow: 1px 1px 1px #7A070D !important;}.boardSubtitle, .boardBanner .boardSubtitle > a{text-shadow: none !important;}.postNum a { color: #000000 !important; }'
                },
                {
                    name:        "Yotsuba Purple",
                    author:      "seaweed",
                    ...
                    titleColor:  "0f0c5d",
                    timeColor:   "000000",
                    customCSS:   '\n\n\n\n\n\n#boardNavDesktop,.pagelist,#imgControls,html::after{background:rgba(229, 219, 240," + this.navOp + ")!important;}#delform,.reply,.hidden_thread,.stub{border-radius:0!important}.reply,.hidden_thread,.stub"+($SS.conf["Recolor Even Posts"] ? ",.replyContainer:nth-of-type(even)>div" : "")+"{border-left:1px solid "+this.mainColor.hex+"!important;border-top:1px solid "+this.mainColor.hex+"!important;}.boardTitle {color: #591177 !important;text-shadow: 1px 1px 1px #222 !important;}.boardSubtitle, .boardBanner .boardSubtitle > a{text-shadow: none !important;}.postNum a { color: #000000 !important; }'
                },
                {
                    name:        "安心院なじみ",
                    "default":   true,
                ...
                },
                {
                    ...
                    titleColor:  "bec2c4",
                    timeColor:   "93a1a1",
                    customCSS:   '.reply:not(.qphl){border-color:"+this.mainColor.hex+" !important}" + ($SS.conf["Add Shadow?"] ? ".thread>.replyContainer>.reply>div.postInfo { box-shadow: 0px 2px 3px #0d272e !important; }" : "") + "'
                },
                {
                ...
                },
                {
                    ...
                    titleColor:  "aaaaaa",
                    timeColor:   "aaaaaa",
                    customCSS:   '" + ($SS.conf["Add Shadow?"] ? ".thread>.replyContainer>.reply>div.postInfo { box-shadow: 0px 2px 3px #2c2c2c !important; }" : "") + "'
                },
                {
                    name:        "Zenburned",
                    author:      "lazy",
