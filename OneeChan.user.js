...
(function()
{
    ...
    $SS =
    {
        ...
        Mascot: function(index)
        {
            ...
            this.offset   = this.bOffset && !this.overflow ? mascot.offset : (($SS.conf["Post Form"] !== 1) && ($SS.conf["Post Form"] !==4) ? 270 : 21);
