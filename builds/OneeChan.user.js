...
($SS.conf["Disable Ads"] ? "div.center,body>div.center:not(:nth-of-type(2)),img.topad,img.bottomad,img.middlead,form[action='https://sys.4chan.org/f/post']~div[style='text-align: center'],form[action='https://sys.4chan.org/f/up.php']>div[style='text-align: center;']," : " div.center img:not(.middlead)," ) + 
