  ...
  $SS =
  {
    ...
    insertCSS: function()
    {
      ...
      $SS.bHideSidebar = $SS.location.sub !== "boards" ||
                $SS.location.board === "f";
      css = "div.post div.file .fileThumb{float:left;margin-left:20px;margin-right:20px;margin-top:3px;margin-bottom:5px}.postContainer{display:block}div.post{margin:4px 0}:root:not(.reply-fit-width) #delform div.reply:not([hidden]){display:table!important}div.thread{margin:0;clear:both}table.flashListing{border-spacing:1px;margin-left:auto;margin-right:auto}div.pagelist div.pages{padding:4px}div.pagelist,div.pagelist>div{float:left}div.pagelist>div span{padding:4px;display:inline-block}.prettyprint{padding:5px!important;display:inline-block;max-height:400px;overflow-x:auto;max-width:600px}s{text-decoration:none!important}span.spoiler,s{color:#000!important;background:none repeat scroll 0 0 #000!important}span.spoiler:hover,s:hover,span.spoiler:focus,s:focus{color:#fff!important}#globalMessage,.boardBanner{text-align:center}div.sideArrows{float:left;margin-right:2px;margin-top:0;margin-left:2px;opacity:.3}hr{clear:both}#boardNavDesktopFoot{clear:both}table{border-spacing:1px;margin-left:auto;margin-right:auto}.deleteform,.pagelist,.pagelist input{font-size:0!important}.fileInfo,.summary{font-size:11px!important}.qr-link{font-size:14px!important}.tab-label,.options-button,.theme-preview,#oneechan-options input,textarea{font-family:sans-serif!important;font-size:12px!important}.boardBanner .boardTitle{font-weight:400!important;font-family:sans-serif!important;font-size:28px!important}body,.prev span::after,.prev form::after,.next span::after,.next form::after,.pages a{font-family:" + $SS.formatFont($SS.conf["Font Family"]) + ";font-size:" + $SS.conf["Font Size"] + "px}:root.underline-disabled a{text-decoration:none}:root.underline-disabled .filtered{text-decoration:line-through}.name,.subject,.option.header .option-title{font-weight:700}.qr-link{font-weight:400}.summary{font-style:italic}.mobile,.fourchanx-link:not(.hide-board-list-container)::before,.fourchanx-link:not(.hide-board-list-container)::after,.tab-select:not(:checked)+div,iframe[src='about:blank'],#absbot,.stylechanger,.topad.center,.middlead.center,.bottomad.center,#delPassword,.boardBanner>img,.boardBanner>img~div,:root.hide-checkboxes .post input[type=checkbox],:root.hide-checkboxes .post .riceCheck,:root.hide-checkboxes .deleteform,:root.hide-board-name .boardTitle,:root.hide-board-name .boardSubtitle,:root.hide-text-board .boardSubtitle,:root.hide-banner #bBanner,:root.hide-button .qr-link-container,:root.reply-fit-width .sideArrows,body>hr,.navLinks{display:none}input:focus,textarea:focus,a{outline:0!important}#delform>hr,.board>hr:last-of-type{background:none!important}div[style='float: right;']{color:transparent!important}html,body,div.boardBanner,#menu,input:not(.jsColor),textarea,#qr-filename-container{color:" + $SS.theme.textColor.hex + "!important}.name{color:" + $SS.theme.nameColor.hex + "!important}.postertrip{color:" + $SS.theme.tripColor.hex + "!important}a{color:" + $SS.theme.linkColor.hex + "!important}a.summary,.pages strong>a{color:" + $SS.theme.textColor.hex + "!important}a:hover{color:" + $SS.theme.linkHColor.hex + "!important}#header-bar,a.current{color:" + $SS.theme.headerColor.hex + "!important}#header-bar a:not(.current){color:" + $SS.theme.headerLColor.hex + "!important}#header-bar a:hover{color:" + $SS.theme.headerLHColor.hex + "!important}.quote{color:" + $SS.theme.quoteColor.hex + "!important}.subject,.option.header .option-title{color:" + $SS.theme.titleColor.hex + "!important}.options-button,a.qr-link{color:" + $SS.theme.jlinkColor.hex + "!important}.boardTitle{color:" + $SS.theme.boardColor.hex + "!important;text-shadow:1px 1px 1px rgb\(" + $SS.theme.boardColor.shiftRGB(-100) + ")!important}.backlink{color:" + $SS.theme.blinkColor.hex + "!important}html,body{background:" + $SS.theme.bgColor.hex + "!important}.reply,.dialog,.tab-label,.flashListing tr:nth-of-type(2n+1){background:rgba(" + $SS.theme.mainColor.rgb + "," + $SS.theme.replyOp + ")!important}:root.recolor-even .thread>.replyContainer:nth-of-type(even):not(.hidden) .post{background:rgb\(" + $SS.theme.mainColor.shiftRGB(-10) + ")!important}#header-bar{background:linear-gradient(rgb\(" + $SS.theme.headerBGColor.shiftRGB(15) + "),rgba(" + $SS.theme.headerBGColor.rgb + "," + $SS.theme.navOp + "))!important}.options-button,.qr-link,.pages strong>a{background:linear-gradient(rgb\(" + $SS.theme.mainColor.shiftRGB(15) + "),rgb(" + $SS.theme.mainColor.rgb + "))}.options-button:hover,.import-input:hover+.options-button,.pages strong>a:hover{background:rgb\(" + $SS.theme.mainColor.shiftRGB(15) + ")}.focused.entry{background:rgb\(" + $SS.theme.mainColor.shiftRGB(10) + ")!important}.qr-link:hover{background:rgb\(" + $SS.theme.mainColor.rgb + ")}input:not(.jsColor),textarea,.riceCheck,#qr-filename-container{background:" + $SS.theme.inputColor.hex + "!important;transition:background .2s}input[type=checkbox],.riceCheck{background:rgb\(" + $SS.theme.inputColor.shiftRGB(20) + ")!important}input:not(.jsColor):hover,.riceCheck:hover,#qr-filename-container:hover,textarea:hover{background:rgb(" + $SS.theme.inputColor.hover + ")!important;transition:background .2s}hr{background-image:linear-gradient(to left,rgba(" + $SS.theme.brderColor.rgb + ",0),rgb(" + $SS.theme.brderColor.rgb + "),rgba(" + $SS.theme.brderColor.rgb + ",0))}#unread-line{background-image:linear-gradient(to left,rgba(" + $SS.theme.jlinkColor.rgb + ",0),rgb(" + $SS.theme.jlinkColor.rgb + "),rgba(" + $SS.theme.jlinkColor.rgb + ",0))}.inline{background:rgba\(" + $SS.theme.mainColor.shiftRGB(-16) + ",.8)!important}:root.post-info .reply>.postInfo{background:rgba\(" + $SS.theme.mainColor.shiftRGB(-16) + ",.2)}.reply{border-width:0 1px 1px 0;border-style:solid}:root.borders-all .reply{border-width:1px}:root.borders-none .reply{border-width:0}:root.rounded-corners .reply,:root.rounded-corners .dialog:not(#header-bar),:root.rounded-corners .inline{border-radius:3px}:root.post-info .reply>.postInfo{border-bottom:1px solid rgb\(" + $SS.theme.mainColor.shiftRGB(4) + ")}:root.post-info.rounded-corners .reply>.postInfo{border-radius:3px 3px 0 0}.reply,.dialog,.entry,.inline,fieldset,.flashListing td:not(:last-of-type):not(.postblock){border-color:" + $SS.theme.brderColor.hex + "!important}input,textarea,.riceCheck,#qr-filename-container{border:1px solid " + $SS.theme.inputbColor.hex + "!important}.options-button,.qr-link,.pages strong>a{border-style:solid;border-width:1px;border-color:rgb\(" + $SS.theme.mainColor.shiftRGB(-15) + ") rgb\(" + $SS.theme.mainColor.shiftRGB(-15) + ") rgb\(" + $SS.theme.mainColor.shiftRGB(-30) + ")!important}input:focus,textarea:focus,#qr-filename-container:focus{border:1px solid " + $SS.theme.linkColor.hex + "!important}#header-bar{border:0!important}.flashListing td:not(:last-of-type):not(.postblock){border-width:1px;border-style:solid}.qphl{outline:2px solid rgba(" + $SS.theme.linkColor.rgb + ",.5)!important}#add-mascot,#add-theme,#oneechan-options{border:0!important;border-radius:3px!important;position:fixed;top:0;bottom:0;left:0;right:0;margin:auto}#oneechan-options{height:532px;width:900px;text-align:left!important}.options-close,.options-container{padding:5px}.options-close{text-align:right!important}#add-mascot{height:125px;width:600px;text-align:right!important;padding:5px!important}#add-theme{height:377px;text-align:right!important;padding:5px!important}#add-mascot .option-title,#add-theme .option-title{float:left;line-height:22px;padding-left:5px}#add-mascot>label,#add-theme>label{line-height:22px}#options-container{border-radius:5px}#options-container,.options-section{height:500px}.options-section{overflow:auto}#main-section .option{display:block;border-top:1px solid rgba(0,0,0,.1);height:22px;padding:0 6px;vertical-align:middle}#main-section>.option:nth-of-type(even){background:rgb\(" + $SS.theme.mainColor.shiftRGB(-5) + ")!important}#main-section .buttons-container+.option{border-top:0!important}.option-title{line-height:20px!important}#main-section .option:first-child{border-top:0!important}#main-section .option:last-child{border-bottom:0!important}#main-section input,#main-section select{float:right!important}#main-section input[type=checkbox],#main-section .riceCheck{float:left!important;margin-right:5px!important}select[name='Font Family']>option{max-width:150px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}.suboption::before{border-bottom:1px solid rgba(0,0,0,.1);border-left:1px solid rgba(0,0,0,.1);content:'';display:inline-block;float:left;margin-right:2px;height:50%;width:6px}.suboption{padding-left:16px!important}.option.header{cursor:auto!important}.theme-preview{cursor:default}#themes-section .reply{padding:2px!important;position:relative;text-align:left;width:99.4%;border-radius:0!important}.theme-buttons-container{bottom:4px;right:2px;margin:0;opacity:0;position:absolute;z-index:3}.theme-preview:hover .theme-buttons-container{opacity:1}.theme-buttons-container>a{display:inline-block;margin:0 2px;padding:2px 5px;text-align:center;width:50px;border-radius:3px}.theme-preview .sfw-label{bottom:-5px;font-size:32px!important;margin:0!important;opacity:0;position:absolute;right:300px}.theme-preview.selected:not(.nsfw) .sfw-label,.theme-preview.nsfw:not(.selected) .sfw-label,.theme-preview.nsfw.selected .both{transition:opacity .3s,right .3s}.theme-preview.nsfw .notsafe{opacity:1;right:3px;z-index:1}.theme-preview.selected .safe{opacity:1;right:3px;z-index:1}.theme-preview.selected.nsfw .sfw-label:not(.both){opacity:0!important;right:300px!important;z-index:0!important}.theme-preview.selected.nsfw .both{opacity:1;right:3px;z-index:1}#add-theme{text-align:left!important;width:800px!important}#add-theme>label{display:inline-block;text-align:right;width:33.3%}#add-theme>label#customCSS{width:100%}#add-theme>label#customCSS>textarea{height:100px;resize:vertical;width:100%}#add-theme>label>input[type=text],#add-theme>label>select{width:100px}#add-theme>div{margin-top:.6em;text-align:right}#mascot-section{text-align:center}.mascot-preview{background-position:center!important;background-repeat:no-repeat!important;background-size:contain!important;display:inline-block;height:257px;margin:2px;position:relative;width:210px;border-radius:10px;transition:all .1s}.mascot-preview:not(:hover) a{opacity:0}.mascot-preview.selected{background-color:rgba(" + $SS.theme.linkColor.rgb + ",.6)!important;box-shadow:inset rgba(0,0,0,.15) 0 0 15px,rgba(" + $SS.theme.linkColor.rgb + ",.6) 0 0 2px}.mascot-preview a{position:absolute;top:0;padding:5px 8px;background:rgba(0,0,0,.3);cursor:pointer}.mascot-preview a:not([href]):hover{background:rgba(0,0,0,.5)}.mascot-link.delete{left:0;border-radius:10px 0}.mascot-link.edit{right:0;border-radius:0 10px}#add-mascot{width:350px!important}#mascot-buttons-container{padding:5px}.add-mascot-label{display:block}.mascot-input,.mascot-select{margin-top:1px!important;width:200px}.mascot-select,.mascot-input.offset{width:80px}.add-mascot-label>input[type=checkbox],.add-mascot-label>.riceCheck{margin-top:5px}#options-tabs{list-style:none;margin:0;padding:0;position:absolute;top:-24px;left:-1px}.tab-item{float:left;margin:0;padding:0}.tab-label{color:#888!important;display:block;height:16px;margin:0 1px;padding:5px;text-align:center;width:75px;border-radius:3px 3px 0 0;transition:all .1s ease-in-out}.tab-label:not(.selected):not(:hover){opacity:.8}#overlay{text-align:center}#overlay2{background:rgba(0,0,0,.5);position:fixed;top:0;left:0;height:100%;width:100%;text-align:center;z-index:999!important}#overlay2::before{content:'';display:inline-block;height:100%;vertical-align:middle}.buttons-container{bottom:3px;left:5px;position:absolute}.buttons-container{margin:0}.options-button{display:inline-block;line-height:18px;margin:0 2px;min-width:40px;padding:2px 10px;text-align:center;cursor:pointer;border-radius:3px}.options-button-small{padding:2px 5px;min-width:30px}#import-link{height:22px;line-height:22px;overflow:hidden;position:relative;float:left;height:24px!important;margin-top:-2px;padding-top:2px}.import-input{position:absolute;opacity:0;cursor:pointer}label.option>input[type=checkbox],label.option>.riceCheck{margin:4px 2px 0!important;vertical-align:bottom!important}span.option>select,.option>input[type=text]{width:125px}#oneechan-options input[type=text],#oneechan-options select{max-height:20px;margin-top:1px!important;padding:1px 3px!important}#oneechan-options select{padding:1px 1px 1px 0!important}#oneechan-options textarea{background:transparent!important;border:0!important;height:100%!important;width:100%!important;resize:none}#oneechan-version{opacity:.5;padding-right:5px;margin-left:160px}.link-delim{opacity:.4}#issues-link{padding-right:10px}body{margin-left:" + $SS.conf["Margin Left"] + "px;margin-right:" + $SS.conf["Margin Right"] + "px}.postInfo{padding:4px 12px 2px;display:block!important}.fileInfo{margin-left:20px;margin-right:10px}.useremail::before{margin-bottom:-20px;display:inline-block}.summary{margin-left:20px}.expanded-image{position:relative}.fileThumb img{border-radius:2px}:root.expand-cover #qr{z-index:8!important}:root.expand-cover .expanded-image{z-index:9!important}:root.force-op .op::after{clear:both;content:'';display:block}.replyContainer{margin-bottom:" + $SS.conf["Margin Between Replies"] + "px!important}:root.reply-fit-width .reply.post{display:block!important;overflow:hidden}:root.reply-fit-width .expanded-image>.post{overflow:visible!important}:root.reply-fit-width .expanded-image>.post::after{clear:both!important;content:''!important;display:block!important}:root.reply-fit-width .threadContainer{margin-left:0!important;padding-left:20px!important}:root.post-info .reply>.postInfo{box-shadow:inset rgba(0,0,0,.05) 0 -1px 2px;padding-top:2px!important}:root.post-info .inline .reply{padding:0!important}:root.backlink-bottom .post{position:relative;padding-bottom:2px}:root.backlink-bottom .container{position:absolute;bottom:2px;right:6px}.reply .menu-button i{position:relative;bottom:1px}:root.reply-fit-width .reply .container{margin-left:-4px!important;padding-right:5px}:root.reply-fit-width .post .menu-button{float:right;margin-left:0;position:relative;left:5px}:root.reply-fit-width .post .menu-button{opacity:0}:root.reply-fit-width .post:not(:hover) .menu-button{transition:opacity .3s ease-out 0s!important}:root.reply-fit-width .post:hover .menu-button{opacity:1;transition:opacity .3s ease-in .1s!important}input[type=checkbox],input[type=submit],.riceCheck{cursor:pointer}input[type=checkbox],.riceCheck{display:inline-block;height:10px!important;position:relative;vertical-align:top;width:10px!important;border-radius:2px!important;-webkit-appearance:none}.riceCheck{margin:2px 3px 0 0}input[type=checkbox]{margin:3px 3px 0 0}#qr .riceCheck,#qr input[type=checkbox]{margin:3px 4px 0!important;vertical-align:baseline;position:relative;top:1px}#qr label{vertical-align:middle}input[type=checkbox]:checked::before,input[type=checkbox]:checked+.riceCheck::before{content:'';display:block;height:8px;margin:1px;width:8px}input[type=checkbox]:checked::before,input[type=checkbox]:checked+.riceCheck::before{background:" + $SS.theme.checkMark.get() + "!important}#header-bar{padding:4px 4px 5px!important}:root:not(.fixed) #header-bar{position:absolute;top:0;right:0;left:0;box-shadow:0 1px 2px rgba(0,0,0,.15);border-bottom:1px solid}:root:not(.fixed) body{padding-top:2em}:root.index.bottom:not(.autohide) body{padding-bottom:4em!important}:root.autohide body{padding-top:0!important;padding-bottom:0!important}:root.fixed:not(.autohide):not(.bottom) #delform{margin-top:-15px}.qr-link{border-radius:3px;vertical-align:middle;padding:7px 12px 6px}#qr .close{padding:2px 3px 2px 4px!important}#qr [type=submit]{height:22px!important;margin-top:1px}:root.vertical-qr #qr{position:fixed!important;right:0!important;bottom:0!important}:root.vertical-qr #qr.autohide:not(:hover):not(.has-focus){position:fixed!important;transform:rotate(-90deg);transform-origin:bottom right;right:0!important;bottom:300px!important;min-width:240px!important;width:240px!important}:root.vertical-qr #qr.autohide:not(:hover):not(.has-focus) select{max-width:120px!important}:root.vertical-qr.left-sidebar #qr.autohide:not(:hover):not(.has-focus){transform:rotate(90deg);left:-244px!important;bottom:50px!important;right:auto!important}:root.fade-qr #qr form{display:block!important}:root.fade-qr #qr.autohide:not(.has-focus):not(:hover){opacity:.2!important;transition:opacity .2s ease-in-out 1s}:root.expand-inputs .persona .field{transition:width ease-in-out 1s,max-width ease-in-out 1s}:root.expand-inputs .persona .field:focus{position:absolute;right:2px;left:2px;width:99%!important;min-width:99%!important;transition:width ease-in-out 1s,max-width ease-in-out 1s}div[style='float: right;']{float:none!important}.deleteform input[type=checkbox],.deleteform .riceCheck{top:3px}:root.hide-name .tripcode{position:absolute;left:1px!important;pointer-events:none;width:33.2%!important;min-width:33.2%!important}:root.hide-name .field[name=name]:hover+.tripcode,:root.hide-name .field[name=name]:focus+.tripcode,:root.hide-name .tripcode:hover{display:none!important}hr{height:2px;width:600px;border:0!important}:root.reply-fit-width #unread-line{margin:auto;width:100%}#unread-line{margin-top:-3px!important;margin-bottom:-3px!important}.boardBanner .boardTitle{cursor:default;letter-spacing:-3px}.boardBanner>img{border:0!important}:root.banner-reflect.gecko:not(.hide-banner) #bBanner{position:relative!important}:root.banner-reflect.gecko:not(.hide-banner) #bBanner::after{background-image:-moz-element(#banner);bottom:-93%;content:'';left:0;mask:url(data:image/svg+xml;base64,#mask);opacity:.1;position:absolute;right:0;top:97%;-moz-transform:scaleY(-1);width:300px;margin:auto!important;pointer-events:none}:root.banner-reflect.webkit:not(.hide-banner) #banner{-webkit-box-reflect:below 0 -webkit-gradient(linear,left top,left bottom,from(transparent),color-stop(.1,transparent),to(rgba(255,255,255,.1)))}:root.banner-opacity #banner{opacity:.5}.pages strong>a{border-radius:3px}.pagelist{margin:0 10px 20px 100px}.pages a{padding:5px 10px;margin-left:-1px}.next{position:relative;float:right!important;width:10px}.prev{position:relative;width:10px}.prev span{position:relative;right:5px}.prev span::after,.prev form::after{content:'<';position:absolute;top:4px;left:1px;pointer-events:none}.next span::after,.next form::after{content:'>';position:absolute;top:4px;right:2px;pointer-events:none}.pagelist input{background:none!important;border:0!important;box-shadow:none!important;-moz-appearance:none!important;-webkit-appearance:none!important;height:20px;width:20px}.pagelist span{opacity:.2}.cataloglink{margin-left:-10px}table.flashListing{margin:auto!important}table.flashListing .highlightPost{background:none!important}table.flashListing .highlightPost::after{content:'●';color:#d69595;position:relative;left:12px;margin-left:-10px}.flashListing>tbody{padding-top:200px}.flashListing td{padding-left:4px!important;padding-right:4px!important;text-align:center!important}#delform[action='https://sys.4chan.org/f/up.php'],#delform[action='https://sys.4chan.org/f/up.php'] .postblock{background:none!important;border:0!important;box-shadow:none!important}.watch-thread-link{margin-bottom:-6px;margin-right:6px;top:auto!important;bottom:4px!important;background-image:url(\"data:image/svg+xml," + $SS.theme.icons.heart + "\")!important}:root.backlink-icon .backlink{background-image:url(\"data:image/svg+xml,"+$SS.theme.icons.backlink+"\")!important;font-size:0!important;padding:6px!important;margin-right:0!important;opacity:.6!important;position:relative;bottom:5px;right:2px}:root.backlink-icon .reply .backlink{bottom:6px!important}:root.backlink-icon .backlink:hover,:root.backlink-icon .backlink.inlined{opacity:1!important}" + ($SS.conf["Sidebar Position"] !== 3 ? " :root:not(.fixed) #header-bar{z-index:10}:root.left-sidebar body{padding-left:303px}:root.right-sidebar body{padding-right:303px}.boardBanner{position:fixed;top:1px}:root.left-sidebar .boardBanner{left:1px}:root.right-sidebar .boardBanner{right:1px}:root.fixed:not(.autohide):not(.bottom) .boardBanner{margin-top:25px}#banner{width:100%}#bBanner{margin-bottom:40px}#bBanner::after{width:100%!important}.qr-link-container{margin-top:-15px}#qr{bottom:0!important;top:auto!important;min-width:297px!important}:root.left-sidebar #qr{left:0!important;right:auto!important}:root.right-sidebar #qr{right:0!important;left:auto!important}:root.fixed.bottom:not(.autohide) #qr{margin-bottom:26px}.captcha-img,.captcha-img img{min-width:100%!important;height:56px!important}:root.ss-sidebar body::before{background:rgba\(" + $SS.theme.mainColor.shiftRGB(-18) + ",." + ($SS.theme.mainColor.isDark ? 9 : 2) + ");border-left:2px solid rgba(" + $SS.theme.mainColor.rgb + ",.9);box-shadow:inset " + $SS.theme.brderColor.hex + " 1px 0 0,inset " + $SS.theme.brderColor.hex + " -1px 0 0;content:'';height:100%;width:302px;position:fixed;top:0;right:0}:root.ss-sidebar.left-sidebar body::before{border-right:2px solid rgba(" + $SS.theme.mainColor.rgb + ",.9);border-left:0!important;left:0;right:auto!Important}" : "") + " " + $SS.theme.customCSS + "";
      if ($("#ch4SS").exists())
        $("#ch4SS").text(css);
      else
    ...
    QRDialogCreationHandler: function(e)
    {
      ...
      if ($SS.conf["Secret Name Field"])
        $(".field[name=name]").after($("<input class='tripcode field' placeholder=Name>"));
